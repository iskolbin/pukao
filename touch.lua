...
Touch = {
	...
	processTouchEvent = function( self, x, y, event, ... )
		self:emit( event, x, y, ... )
	...
	onTouchUp = function( self, idx, x, y ) 
		self:processTouchEvent( x, y, 'onTouchUp', idx ) 
	end,
	
	onTouchDown = function( self, idx, x, y ) 
		self:processTouchEvent( x, y, 'onTouchDown', idx ) 
	end,
	
	onTouchMove = function( self, idx, x, y, dx, dy ) 
		self:processTouchEvent( x, y, 'onTouchMove', idx ) 
	end,
